...
import { hasErrored, addMessage, removeMessage } from '../../actions';
...
export const mapDispatchToProps = dispatch => bindActionCreators({ hasErrored, addMessage, removeMessage }, dispatch);
